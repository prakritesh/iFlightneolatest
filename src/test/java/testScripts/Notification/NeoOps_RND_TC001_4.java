...
public class NeoOps_RND_TC001_4 {
	...
	void setUp() {
		...
		Driver.setUpTestExecution(tcName, "Displaying the Notification by severity & Group");
		// launch application
	...
	public void login() throws Exception {
		try {
			...
			IFlightNeo_Notification.filterByFirstDropDown(driver,"Severity","High");
			IFlightNeo_Notification.filterByFirstDropDown(driver,"Groups","Rule Violation");
