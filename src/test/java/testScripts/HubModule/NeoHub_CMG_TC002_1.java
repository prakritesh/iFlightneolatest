...
public class NeoHub_CMG_TC002_1 {
	...
	public void flightconnection() throws Exception {
        ...
        IFlightNeo_Hub RTT= new IFlightNeo_Hub();
         ...
         htmlLib.logReport("Check RTT value ", "RTT value Prior to change: "+Rttinitial, "INFO",
					driver, true);
		...
		{	
			htmlLib.logReport("Check RTT value ", "RTT value changed successfully from old value: '" + Rttinitial + "' to new value: "+ RTTNew , "Pass",
					driver, true);
